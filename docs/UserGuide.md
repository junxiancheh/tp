...
Possible errors:
* Invalid command: Extraneous input commands
* Invalid equipment name, room name, or tag format
* Identical tag already exists on the specified equipment or room
...
Examples:
* `untag Wilson-Evolution-Basketball-1 IHG`
* `untag MPSH-1 IHG`
