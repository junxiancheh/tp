...
public class JsonAdaptedEquipmentTest {
    ...
    public void toModelType_validEquipmentDetails_returnsEquipment() throws Exception {
        JsonAdaptedEquipment equipment = new JsonAdaptedEquipment(VALID_NAME, VALID_CATEGORY, VALID_STATUS, VALID_TAGS);
        assertEquals(new EquipmentName(VALID_NAME), equipment.toModelType().getName());
    }

    @Test
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEquipment equipment = new JsonAdaptedEquipment(INVALID_NAME, VALID_CATEGORY,
    ...
    public void toModelType_invalidStatus_throwsIllegalValueException() {
        JsonAdaptedEquipment equipment = new JsonAdaptedEquipment(VALID_NAME, VALID_CATEGORY,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedEquipment equipment = new JsonAdaptedEquipment(null, "Basketball", "Available", VALID_TAGS);
        assertThrows(IllegalValueException.class, equipment::toModelType);
    }

    @Test
    public void toModelType_nullCategory_throwsIllegalValueException() {
        JsonAdaptedEquipment equipment = new JsonAdaptedEquipment("Wilson-Evolution", null, "Available", VALID_TAGS);
        assertThrows(IllegalValueException.class, equipment::toModelType);
    }
}
